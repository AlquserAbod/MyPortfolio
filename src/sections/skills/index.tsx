  ...
  return (
    <div className={styles.container} id="skills">
      ...
      <div className={styles.flexContainer}>
        <SkillCard
          title={t("skills.html.title")}
          icon={htmlIcon}
          content={t("skills.html.content")}
        />
        <SkillCard
          title={t("skills.css.title")}
          icon={cssIcon}
          content={t("skills.css.content")}
        />
        <SkillCard
          title={t("skills.expressjs.title")}
          icon={expressjsIcon}
          content={t("skills.expressjs.content")}
        />
        <SkillCard
          title={t("skills.nextjs.title")}
          icon={nextjsIcon}
          content={t("skills.nextjs.content")}
        />
        <SkillCard
          title={t("skills.tailwindcss.title")}
          icon={tailwindcssIcon}
          content={t("skills.tailwindcss.content")}
        />
        <SkillCard
          title={t("skills.dart.title")}
          icon={dartIcon}
          content={t("skills.dart.content")}
        />
        <SkillCard
          title={t("skills.flutter.title")}
          icon={flutterIcon}
          content={t("skills.flutter.content")}
        />
        <SkillCard
          title={t("skills.javascript.title")}
          icon={javascriptIcon}
          content={t("skills.javascript.content")}
        />
        <SkillCard
          title={t("skills.typescript.title")}
          icon={typescriptIcon}
          content={t("skills.typescript.content")}
        />
        <SkillCard
          title={t("skills.react.title")}
          icon={reactIcon}
          content={t("skills.react.content")}
        />
        <SkillCard
          title={t("skills.node.title")}
          icon={nodeIcon}
          content={t("skills.node.content")}
        />
        <SkillCard
          title={t("skills.mongodb.title")}
          icon={mongodbIcon}
          content={t("skills.mongodb.content")}
        />
        <SkillCard
          title={t("skills.sass.title")}
          icon={sassIcon}
          content={t("skills.sass.content")}
        />
      </div>
    </div>
  );
