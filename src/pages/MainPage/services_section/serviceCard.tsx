...
const ServiceCard: React.FC<ServiceCardProps> =  ({title, description, iconName}) => {
    ...
    useEffect(() => {
        const loadIcon = async () => {
            try {
                ...
                const iconModule = await import(`@/assets/icons/services/${iconName}.png`);
  ...
  return (
    <div className={styles.container}>
        ...
        {iconUrl ? <img src={iconUrl} alt="Service Icon" width={50} /> : <div></div>}
        </div>
        ...
        <div className={styles.contactUs} onClick={(e) => {
                e.preventDefault();
